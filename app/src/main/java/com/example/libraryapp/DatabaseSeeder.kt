    ...
    private suspend fun seedBooks(bookDao: BookDao) {
        try {
            val books = listOf(
                ...
                Book(id = 14, title = "Hukum Pidana Adat", author = "Prof. Dr. Barda Nawawi Arief, S.H.", year = 2002, synopsis = "Kajian tentang hukum pidana yang bersumber dari adat.", coverPath = "https://drive.google.com/uc?id=1v9vR8M45zcjQkg_614wFiuPQ3tAKuGkx", queueCount = 0, availableCount = 7),
